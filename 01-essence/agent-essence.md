...
本文通过逐行解读一个百行出头的极简 Agent 实现—— nanoagent，带你彻底搞懂这些问题。理解了这份脚本，你就理解了 OpenClaw、Claude Code、Cursor Agent 等一切 Coding Agent 的共同底座。
...
这些问题，我们在 [第二篇：记忆与规划](../02-memory/agent-memory.md) 中解答。代码规模虽然只是继续小幅增加，但能力会从“单次执行”跃迁到“跨任务延续”。
